...
public:
    ...
    void setupUi(QDialog *SettingsDialog)
    {
        ...
        HexCheckBox = new QCheckBox(additionalOptionsGroupBox);
        HexCheckBox->setObjectName(QStringLiteral("HexCheckBox"));
        HexCheckBox->setChecked(true);

        verticalLayout->addWidget(HexCheckBox);
    ...
    void retranslateUi(QDialog *SettingsDialog)
    {
        ...
        HexCheckBox->setText(QApplication::translate("SettingsDialog", "Hexadecimal", Q_NULLPTR));
    } // retranslateUi
